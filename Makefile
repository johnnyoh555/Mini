...
SRCS = minishell.c tokenizer.c tokenizer_list.c parser_tree.c parser.c parser_utils.c parser_tree_order.c print_test.c command_list.c command_list_utils.c signal_process.c\
...
./excute/extend_env.c ./excute/change_env.c ./excute/remove_quote.c
OBJS = $(SRCS:.c=.o)
NAME = minishell
LIBFT_DIR = libft
LIBFT = libft.a
