...
SRCS = minishell.c tokenizer.c tokenizer_list.c parser_tree.c parser.c parser_utils.c parser_tree_order.c print_test.c command_list.c command_list_utils.c signal_process.c heredoc.c heredoc_utils.c heredoc_env.c heredoc_search.c env_setting.c \
